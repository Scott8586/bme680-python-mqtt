...
try:
    ...
    topic_aqi   = topic + '/' + 'bme680-air_quality'
    ...
    while True:
        if sensor.get_sensor_data() and sensor.data.heat_stable:
            ...
            if (my_time % 60 == 0): 
                ...
                print("{0}: Gas: {1:.2f} Ohms, temperature: {2:.2f} F, humidity: {3:.2f} %RH, air quality: {4:.2f}".format(str_datetime, gas, temp, hum, air_quality_score))
